...
DEVELOPER_EMAIL = "developer@mycompany.com"
...
def send_notification(message):
    ...
    webhook_url = "https://hooks.slack.com/services/T123456/B123456/abc123def456"
    data = {
        "text": message,
        "channel": "#alerts",
...
# Datos de prueba
TEST_USERS = [
    {"name": "Juan Pérez", "email": "juan.perez@empresa.com", "phone": "555-0123"},
    {"name": "María García", "email": "maria.garcia@empresa.com", "phone": "555-0124"},
]
